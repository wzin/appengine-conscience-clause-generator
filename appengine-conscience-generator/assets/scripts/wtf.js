    ...
    */
    ...
    function generate() {
        ...
        while ( item && ++iter < 1000 ) {
            ...
            var tt_text = '<a href="https://twitter.com/share" class="twitter-share-button" data-url="http://klauzula-sumienia.pl" data-text=' + '"' + idea + '"' +' data-lang="pl">Tweetnij</a> <script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?"http":"https";if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+"://platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document, "script", "twitter-wjs");</script>';
            console.log("wut wut", idea);
        }
